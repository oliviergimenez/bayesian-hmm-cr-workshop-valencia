...
.center.nogap[
```{r, engine = 'tikz', echo = FALSE, fig.width = 7.5, fig.asp = 0.618}
...
+ Nimble provides the conditional WAIC, where all parameters directly involved in the likelihood are considered. If you would want to calculate the marginal WAIC, integrating over latent variables, it is also possible, check out `help(waic)` and section 7.8 of the [User's manual](https://r-nimble.org/html_manual/cha-welcome-nimble.html).
...
```{r echo = FALSE}
load(here::here("slides","dat","dipper_waic.RData"))
...
.center[
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.width = 7.5, fig.asp = 0.618, dev = "svg"}
load(here::here("slides","dat","dipper.RData"))
PR <- runif(1500, 0, 1)
MCMCtrace(mcmc.phip, 
          params = c('phi'),
...
.center[
```{r, echo = FALSE, warning=FALSE, message=FALSE,fig.width = 7.5, fig.asp = 0.618, dev = "svg"}
load(here::here("slides","dat","phip3y.RData"))
phinoprior <- c(mcmc.phip$chain1[,"phi"], mcmc.phip$chain2[,"phi"])
load(here::here("slides","dat","phipriorp3y.RData"))
...
.center[
```{r, echo = FALSE, fig.width = 7.5, fig.asp = 0.518, dev = "svg"}
load(here::here("slides", "dat", "profiledeviance.RData"))
...
.pull-left[
.center[
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.width = 7.5, fig.asp = 0.818, dev = "svg"}
load(here::here("slides","dat","dipper.RData"))
PR <- runif(1500, 0, 1)
